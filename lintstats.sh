...
echo "Debugging: PYLINT_SCORE=$PYLINT_SCORE, MIN_SCORE=$MIN_SCORE, PYLINT_PASS=$PYLINT_PASS, PYLINT_STATE=${PYLINT_STATE}, SHA=$SHA, TRAVIS_COMMIT=$TRAVIS_COMMIT, TRAVIS_PULL_REQUEST_SHA=$TRAVIS_PULL_REQUEST_SHA"
