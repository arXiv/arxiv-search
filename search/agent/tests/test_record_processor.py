...
class TestIndexPaper(TestCase):
    ...
    def test_paper_has_one_version(
        self, mock_meta, mock_tx, mock_idx, mock_client_factory
    ):
...
class TestAddToIndex(TestCase):
    ...
    @mock.patch("boto3.client")
    @mock.patch("search.agent.consumer.index.SearchSession")
    def test_index_raises_index_connection_error(
        self, mock_index, mock_client_factory
    ):
    ...
    @mock.patch("boto3.client")
    @mock.patch("search.agent.consumer.index.SearchSession")
    def test_index_raises_unhandled_error(
        self, mock_index, mock_client_factory
    ):
...
class TestBulkAddToIndex(TestCase):
    ...
    @mock.patch("boto3.client")
    @mock.patch("search.agent.consumer.index.SearchSession")
    def test_bulk_add_documents_succeeds(
        self, mock_index, mock_client_factory
    ):
        """The search document is added successfully."""
        mock_client = mock.MagicMock()
...
class TestTransformToDocument(TestCase):
    ...
    @mock.patch("boto3.client")
    @mock.patch("search.agent.consumer.transform")
    def test_transform_raises_exception(
        self, mock_transform, mock_client_factory
    ):
...
class TestGetMetadata(TestCase):
    ...
    @mock.patch("boto3.client")
    @mock.patch("search.agent.consumer.metadata")
    def test_metadata_service_returns_metadata(
        self, mock_metadata, mock_client_factory
    ):
    ...
    @mock.patch("boto3.client")
    @mock.patch("search.agent.consumer.metadata")
    def test_metadata_service_raises_connection_error(
        self, mock_metadata, mock_client_factory
    ):
    ...
    @mock.patch("boto3.client")
    @mock.patch("search.agent.consumer.metadata")
    def test_metadata_service_raises_request_error(
        self, mock_metadata, mock_client_factory
    ):
    ...
    @mock.patch("boto3.client")
    @mock.patch("search.agent.consumer.metadata")
    def test_metadata_service_raises_bad_response(
        self, mock_metadata, mock_client_factory
    ):
