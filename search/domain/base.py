...
class DocMeta:
    ...
    arxiv_publish_date: Optional[str] = field(default=None)
    arxiv_publish_date_resolution: Optional[str] = field(default=None)
    ...
    docmeta_version: Optional[str] = field(default=None)
...
class DateRange:
    ...
    ARXIV_PUBLISH = "arxiv_publish_date"
